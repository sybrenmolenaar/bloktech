...
let db;
const db_key =
  "mongodb+srv://sybrenmolenaar:M@ngo132!@cluster0-e62vx.gcp.mongodb.net/musiclovers?retryWrites=true&w=majority";
MongoClient.connect(db_key, function (err, client) {
  if (err) {
    throw err;
  } else {
  }
  db = client.db("musiclovers");
});

const users = {
  sybrenmolenaar: {
    name: "Sybren Molenaar",
    photos: ["https://unsplash.it/300/300"],
  },
  didiercatz: {
    name: "Didier Catz",
    photos: ["https://unsplash.it/500/500"],
  },
};
